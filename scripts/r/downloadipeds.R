...
dictionary_dir <- file.path(data_dir, 'dictionary')
stata_prog_dir <- file.path(data_dir, 'stata_prog')
spss_prog_dir <- file.path(data_dir, 'spss_prog')
sas_prog_dir <-  file.path(data_dir, 'sas_prog')
